...
//----------Entry & Exit Variables-----------
   ...
   LongEntryBreakout = Crossed1(Close1, DonchianTopEntry1);
   ShortEntryBreakout = Crossed2(Close1, DonchianBottomEntry1);

   LongExitBreakout = Crossed3(Close1, DonchianBottomExit1);
   ShortExitBreakout = Crossed4(Close1, DonchianTopExit1);
